...
#import <KLCache/KLMemoryCache.h>
#import <KLCache/KLDiskCache.h>
#import <KLCache/KLKVStorage.h>
...
/**
 `KLCache` is a thread safe key-value cache.
 
 It use `KLMemoryCache` to store objects in a small and fast memory cache,
 and use `KLDiskCache` to persisting objects to a large and slow disk cache.
 See `KLMemoryCache` and `KLDiskCache` for more information.
 */
@interface KLCache : NSObject

/** The name of the cache, readonly. */
@property (copy, readonly) NSString *name;

/** The underlying memory cache. see `KLMemoryCache` for more information.*/
@property (strong, readonly) KLMemoryCache *memoryCache;

/** The underlying disk cache. see `KLDiskCache` for more information.*/
@property (strong, readonly) KLDiskCache *diskCache;
