...
static inline dispatch_queue_t KLMemoryCacheGetReleaseQueue() {
...
/**
 A linked map used by KLMemoryCache.
...
- (void)removeAll {
    ...
    if (CFDictionaryGetCount(_dic) > 0) {
        ...
        if (_releaseAsynchronously) {
            dispatch_queue_t queue = _releaseOnMainThread ? dispatch_get_main_queue() : KLMemoryCacheGetReleaseQueue();
